...
import com.overthinker.cloud.web.enums.RespEnum;
...
import com.overthinker.cloud.web.utils.ServiceUtil;
...
public class MenuServiceImpl extends ServiceImpl<MenuMapper, Menu> implements MenuService {
    ...
    @Override
    public ResultData<List<MenuVO>> getMenuList(Integer typeId, String username, Integer status) {
    ...
    @Override
    public ResultData<MenuByIdVO> selectUpdateMenu(Long id) {
    ...
    public ResultData<Void> updateMenu(MenuDTO menuDTO) {
        ...
        if (menuMapper.update(menu, wrapper.eq(Menu::getId, menu.getId())) > 0) return ResultData.success();
        return ResultData.failure();
    }
