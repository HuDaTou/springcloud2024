...
public interface ArticleService extends IService<Article> {
     ...
     * @return 是否成功
     */
    ResultData<String> uploadArticleCover(MultipartFile articleCover);
     ...
     * @return 是否成功
     */
    ResultData<Void> publish(ArticleDTO articleDTO);
     ...
     * @return 是否成功
     */
    ResultData<Void> deleteArticleCover(String articleCoverUrl);
     ...
     * @return url
     */
    ResultData<String> uploadArticleImage(MultipartFile articleImage);
     ...
     * @return 是否成功
     */
    ResultData<Void> updateIsTop(Long id, Integer isTop);
