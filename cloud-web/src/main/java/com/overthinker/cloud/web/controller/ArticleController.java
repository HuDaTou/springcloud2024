...
public class ArticleController extends BaseController {
    ...
    public ResultData<List<SearchArticleByContentVO>> searchByContent(
    ...
    public ResultData<List<RelatedArticleVO>> related(
    ...
    public ResultData<List<CategoryArticleVO>> listCategoryArticle(
    ...
    public ResultData<String> uploadArticleCover(@RequestParam("articleCover") MultipartFile articleCover) {
    ...
    @PostMapping("/publish")
    public ResultData<Void> publish(@RequestBody @Valid ArticleDTO articleDTO) {
    ...
    public ResultData<Void> deleteArticleCover(@RequestParam("articleCoverUrl") String articleCoverUrl) {
    ...
    public ResultData<String> uploadArticleImage(
    ...
    public ResultData<Void> updateArticleStatus(
    ...
    public ResultData<Void> updateArticleIsTop(
            @RequestParam("id") @NotNull Long id,
