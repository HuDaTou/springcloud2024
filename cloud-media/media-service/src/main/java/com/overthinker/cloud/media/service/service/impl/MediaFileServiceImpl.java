...
//import com.overthinker.cloud.utils.CommonUtil;
//
//import io.minio.*;
...
//            }
//            //记录待处理的任务，向MediaProcess插入记录,添加到待处理任务表
...
//        if (!b) {
//            return ResultData.validfail(false, "上传分块文件失败");
//        }
//        //上传成功
//        return ResultData.success(true);
//    }
...
//                return ResultData.validfail(false, "文件校验失败");
//            }
//            //文件大小
...
//        if (mediaFiles == null) {
//            return ResultData.validfail(false, "文件入库失败");
//        }
//        //==========清理分块文件=========
