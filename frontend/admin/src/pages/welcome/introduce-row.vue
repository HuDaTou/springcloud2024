...
import ChartCard from '~/pages/cms/analysis/components/chart-card.vue'
import Field from '~/pages/cms/analysis/components/field.vue'
import Trend from '~/pages/cms/analysis/trend.vue'
