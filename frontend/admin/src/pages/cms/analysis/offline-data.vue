...
import NumberInfo from '~/pages/cms/analysis/number-info.vue'
import CustomRingProgress from '~/pages/cms/analysis/components/custom-ring-progress.vue'
import CustomLine from '~/pages/cms/analysis/components/custom-line.vue'
