...
public class IDCardUtil {
    ...
    public static Map<String, String> getInfo(String idNumber) {
        ...
        if (idNumber.length() == 15) {
            ...
            gender = Integer.parseInt(idNumber.substring(idNumber.length() - 3)) % 2 == 0 ? "F" : "M";
            ...
            gender = Integer.parseInt(idNumber.substring(idNumber.length() - 4, idNumber.length() - 1)) % 2 == 0 ? "女" : "男";
    ...
    public static void main(String[] args) {
        System.out.println(getInfo("231222200205254178"));
    }
}
