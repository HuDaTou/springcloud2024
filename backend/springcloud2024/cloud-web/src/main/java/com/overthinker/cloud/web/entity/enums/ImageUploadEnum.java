...
public enum ImageUploadEnum {
    ...
    // 站长头像
    WEBSITE_INFO_AVATAR("websiteInfo/avatar/", "站长头像", Set.of(ImageConst.JPG, ImageConst.JPEG, ImageConst.PNG, ImageConst.WEBP), 0.3),
    // 站长背景
    ...
    // 文章封面
    ARTICLE_COVER("article/articleCover/", "文章封面", Set.of(ImageConst.JPG, ImageConst.JPEG, ImageConst.PNG, ImageConst.WEBP), 50.0),
    // 文章图片
