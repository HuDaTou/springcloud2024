...
import com.overthinker.cloud.media.constants.Const;
import com.overthinker.cloud.media.enums.UploadEnum;
import io.minio.*;
...
public class FileUploadUtils {
    ...
    public String upload(UploadEnum uploadEnum, MultipartFile file) throws Exception {
        ...
        if (isFormatFile(file.getOriginalFilename(), uploadEnum.getFormat())) {
            ...
            String HOSTNAME = "http://home.overthinker.top:30948";
            return HOSTNAME + "/" + bucketName + "/" + uploadEnum.getDir() + name + "." + fileExtension;
        }
        log.error("--------------------上传文件格式不正确--------------------");
